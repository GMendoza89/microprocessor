...
%           Divisi贸n de Ingenierias Campus Irapuato Salamanca
%       
%
%                   Maestria en Ingenieria El茅ctrica
%
...
% el argumento 1 puede ser un valor literal de 8 bits, direccion de memoria de 8 bits, o una direccion de instrucci贸n de 9 bits, 
% el argumento 2 debe ser 1 o 0 para las instrucciones que tengan la opci贸n de guardar en un registro F o en el registro W, o un argumento de tres bits para indicar 
